...
public class techfest_adp extends RecyclerView.Adapter<techfest_adp.ViewHolder> {

    Context mctx;
    List<awards_Model> products;

    public techfest_adp(Context mctx, List<awards_Model> products) {
        this.mctx = mctx;
        this.products = products;
    }

    @Override
    public techfest_adp.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mctx).inflate(R.layout.awards_inside_row, parent, false);
        techfest_adp.ViewHolder holder = new techfest_adp.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull techfest_adp.ViewHolder holder, int position) {
