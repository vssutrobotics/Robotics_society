...
public class national_adp extends RecyclerView.Adapter<national_adp.ViewHolder> {

    Context mctx;
    List<awards_Model> products;

    public national_adp(Context mctx, List<awards_Model> products) {
        this.mctx = mctx;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        national_adp.ViewHolder holder = new national_adp.ViewHolder(view);
        return holder;
    }
