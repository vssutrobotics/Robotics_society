...
public class eyantra extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dbbproducts = FirebaseDatabase.getInstance().getReference("eyantra");
        dbbproducts.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                events = new robocon_adp(eyantra.this, products);
                pd.hide();
