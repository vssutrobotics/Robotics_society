...
public class techfest extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dbbproducts = FirebaseDatabase.getInstance().getReference("techfest");
        dbbproducts.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                events = new robocon_adp(techfest.this, products);
                pd.hide();
